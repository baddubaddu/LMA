...
<div class="chat-message bot">
    <div class="avatar">
        <img src="https://i.ibb.co/KmBPNhD/logo2.png" style="max-height: 60px; max-width: 60px; border-radius: 50%; object-fit: cover;">
    </div>
...
<div class="chat-message user">
    <div class="avatar">
        <img src="https://i.ibb.co/YyLqXQK/avatar.jpg" style="max-height: 60px; max-width: 60px; border-radius: 50%; object-fit: cover;">
    </div>    
    <div class="message">{{MSG}}</div>
</div>
'''